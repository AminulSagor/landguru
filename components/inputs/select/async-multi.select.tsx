...
interface HookFormAsyncMultiSelectProps<
...
export const HookFormAsyncMultiSelect = <
  TFieldValues extends FieldValues
>({
  name,
  control,
  ...
  onChange,
  loadOptions,
}: HookFormAsyncMultiSelectProps<TFieldValues>) => {
  const {
  ...
  const ClearIndicator = (
    props: ClearIndicatorProps<IOption, true>
  ) => {
