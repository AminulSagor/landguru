...
import BuyPostStepOneForm from "@/app/(user)/dashboard/(pages)/create-buy-post/_components/buy-post-step-one";
import BuyPostStepTwoReview from "@/app/(user)/dashboard/(pages)/create-buy-post/_components/buy-post-step-two-review";
