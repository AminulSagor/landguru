...
import OfferedPostHero from "@/app/(user)/dashboard/(pages)/offer-post-details/_components/offered-post-hero";
import OfferedPostImages from "@/app/(user)/dashboard/(pages)/offer-post-details/_components/offerd-post-images";
import OfferedPostRightSidebar from "@/app/(user)/dashboard/(pages)/offer-post-details/_components/offed-post-right-sidebar";
import OfferingWorksStepper from "@/app/(user)/dashboard/(pages)/offer-post-details/_components/offering-work-stepper";
