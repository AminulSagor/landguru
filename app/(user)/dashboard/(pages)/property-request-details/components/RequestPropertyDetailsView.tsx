...
import { PropertyRequestDetails } from "@/app/(user)/dashboard/(pages)/property-request-details/[id]/page";
import PostSubmittedDialog from "@/app/(user)/dashboard/(pages)/property-request-details/components/post-submitted-dialog";
import SelectPropertyDialog, {
  Listing,
} from "@/app/(user)/dashboard/(pages)/property-request-details/components/select-property-dialog";
