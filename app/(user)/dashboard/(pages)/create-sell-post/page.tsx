...
import SellPropertyStepOneForm from "@/app/(user)/dashboard/(pages)/create-sell-post/_components/sell-property-step-one";
import SellPropertyStepTwoForm from "@/app/(user)/dashboard/(pages)/create-sell-post/_components/sell-property-step-two";
...
import SellPropertyStepThreeForm from "@/app/(user)/dashboard/(pages)/create-sell-post/_components/sell-property-step-three";
import SellPropertyStepFourReview from "@/app/(user)/dashboard/(pages)/create-sell-post/_components/sell-property-step-final";
