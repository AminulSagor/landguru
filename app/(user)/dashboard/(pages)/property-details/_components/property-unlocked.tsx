...
/**
 * PropertyUnlocked (matches your 3 SS)
 * - Same vertical stack
 * - Accordion-like cards with right chevron
 * - Sections: Risk checklist, Property video, Ownership history,
 *   Validated legal documents, Pentagraph map, Services taken
 * - All static for now
 */
  ...
  return (
    <div className="bg-secondary/80 p-6 md:p-8 rounded-xl">
      ...
      <div className="mt-6 space-y-5">
        ...
        <FeatureAccordion
          title="Validated Legal Documents"
          icon={<FileText className="text-primary" size={18} />}
          open={open.legal}
          onToggle={() => toggle("legal")}
          description="Get to see which documents will be provided"
          highlighted
        >
          <ul className="mt-3 list-disc pl-5 text-sm text-primary space-y-1 font-semibold">
            <li>2 deed documents</li>
            <li>Khatian documents</li>
            <li>Tax documents</li>
            <li>Ownership history documents</li>
          </ul>

          <p className="mt-3 text-xs text-black/35">
            Documents will be handed over after successful purchase
          </p>
        </FeatureAccordion>
