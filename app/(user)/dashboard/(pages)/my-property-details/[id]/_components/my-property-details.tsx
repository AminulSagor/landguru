...
import MyPropertyHero from "@/app/(user)/dashboard/(pages)/my-property-details/[id]/_components/my-property-hero";
import MyPropertyImages from "@/app/(user)/dashboard/(pages)/my-property-details/[id]/_components/my-property-images";
import MyPropertyMetrics from "@/app/(user)/dashboard/(pages)/my-property-details/[id]/_components/my-property-metrics";
import MyPropertyRightSidebar from "@/app/(user)/dashboard/(pages)/my-property-details/[id]/_components/my-property-right-sidebar";
...
import MyPropertyUnlocked from "@/app/(user)/dashboard/(pages)/my-property-details/[id]/_components/my-property-unlock";
