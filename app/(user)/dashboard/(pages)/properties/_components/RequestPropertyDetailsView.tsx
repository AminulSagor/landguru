...
import { PropertyRequestDetails } from "@/app/(user)/dashboard/(pages)/properties/request/details/[id]/page";
import SelectPropertyDialog, {
  Listing,
} from "@/app/(user)/dashboard/(pages)/properties/_components/select-property-dialog";
import PostSubmittedDialog from "@/app/(user)/dashboard/(pages)/properties/_components/post-submitted-dialog";
