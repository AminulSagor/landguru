...
import BuyPostRequestDetailsCard from "@/app/(user)/dashboard/(pages)/posts/buy/view/_components/buy-post-details-card";
import OffersPanel from "@/app/(user)/dashboard/(pages)/posts/buy/view/_components/offer-panel";
