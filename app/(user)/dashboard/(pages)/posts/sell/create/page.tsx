...
import SellPropertyStepOneForm from "@/app/(user)/dashboard/(pages)/posts/sell/create/_components/sell-property-step-one";
import SellPropertyStepTwoForm from "@/app/(user)/dashboard/(pages)/posts/sell/create/_components/sell-property-step-two";
...
import SellPropertyStepThreeForm from "@/app/(user)/dashboard/(pages)/posts/sell/create/_components/sell-property-step-three";
import SellPropertyStepFourReview from "@/app/(user)/dashboard/(pages)/posts/sell/create/_components/sell-property-step-final";
  ...
  return (
    <div className="w-full py-24 space-y-10">
      <div className="flex items-center justify-between">
        ...
        <button className="text-primary text-base font-semibold">Save as Draft</button>
      </div>
