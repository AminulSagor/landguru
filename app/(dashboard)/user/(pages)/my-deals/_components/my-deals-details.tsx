...
import MyDealsPropertyUnlocked from "@/app/(dashboard)/user/(pages)/my-deals/_components/my-deals-unlock";
import MyDealsRightSidebar from "@/app/(dashboard)/user/(pages)/my-deals/_components/my-deals-right-sidebar";
import ResellOptionsDialog from "@/app/(dashboard)/user/(pages)/my-deals/_components/resell-options-dialog";
import ResellUpdatePriceDialog from "@/app/(dashboard)/user/(pages)/my-deals/_components/resell-update-price-dialog";
import ResellSubmittedDialog from "@/app/(dashboard)/user/(pages)/my-deals/_components/resell-submitted-dialog";
