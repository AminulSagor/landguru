...
import type { StepTwoValues } from "@/app/(dashboard)/user/types/property-sell-post";
import type { StepThreeValues } from "@/app/(dashboard)/user/types/property-sell-post";
