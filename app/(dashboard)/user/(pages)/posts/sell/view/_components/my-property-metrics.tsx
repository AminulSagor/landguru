...
const MyPropertyMetrics = ({ property }: { property: ListingCard }) => {
  ...
  const sellableAmount = formatLandMetric(
    property.sellableAmount ?? null,
    property.sellableUnit ?? null,
    unit,
  );
  const plotSize = formatLandMetric(
    property.plotSize ?? null,
    property.plotUnit ?? null,
    unit,
  );
  const shareUnit = formatLandMetric(
    property.shareAmount ?? null,
    property.shareUnit ?? null,
    unit,
  );
  const roadDistance = formatDistance(
    property.roadDistanceMin ?? null,
    property.roadDistanceMax ?? null,
  );
