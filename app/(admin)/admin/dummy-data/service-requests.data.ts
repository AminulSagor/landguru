...
} from "@/app/(admin)/admin/types/service-request.types";
...
export const demoServiceRequests: ServiceRequestListItem[] = [
  {
    ...
    latestWorkLog: { title: "Uploaded Final_Report_v2.pdf", timeLabel: "20 mins ago" },
  ...
  },
  {
    ...
    status: "in_progress",
    latestWorkLog: { title: "Site visit checked in.", timeLabel: "Today 10:00 AM" },
...
export const demoServiceDetails: ServiceDetails = {
  ...
  activityLog: [
    { kind: "event", title: "Job Accepted", subtitle: "System Assignment", timeLabel: "Oct 12, 10:05 AM" },
    { kind: "event", title: "Site Visit Scheduled", subtitle: "Location: Block-C, Banani", timeLabel: "Oct 13, 09:00 AM" },
    {
      kind: "note",
      title: "Admin Note",
      body:
        "Found a discrepancy in the CS Khatian volume number compared to the master plan. Will need to verify with the local land office.",
      timeLabel: "Oct 14, 02:30 PM",
    },
    { kind: "file", title: "Uploaded Draft Report", fileName: "v1_draft_analysis.pdf", timeLabel: "Oct 15, 11:00 AM" },
    { kind: "event", title: "Marked Job as Complete", subtitle: "Ready for review", timeLabel: "Oct 15, 04:45 PM" },
  ],
  finalDeliverable: {
