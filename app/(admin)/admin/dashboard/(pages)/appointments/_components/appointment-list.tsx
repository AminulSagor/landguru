...
import { AppointmentTabStatus } from "@/app/(admin)/admin/dashboard/(pages)/appointments/page";
import {
  agentSchedules,
  appointments,
} from "@/app/(admin)/admin/dummy-data/appointment-data";
import type {
  AgentSchedule,
  Appointment,
} from "@/app/(admin)/admin/types/appointment-types";
